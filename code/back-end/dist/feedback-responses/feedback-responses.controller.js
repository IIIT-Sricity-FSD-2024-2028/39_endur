...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'studentId', required: false, example: 'S001' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'courseId', example: 'CS101' }),
    (0, swagger_1.ApiQuery)({ name: 'cycleId', required: false, example: 'C001' }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'courseId', required: true, example: 'CS101' }),
    (0, swagger_1.ApiQuery)({ name: 'studentId', required: true, example: 'S001' }),
    (0, swagger_1.ApiQuery)({ name: 'cycleId', required: true, example: 'C001' }),
